export default function Home() {
  return (
    <main className="home-main" style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 20, padding: 40 }}>
      <style>{`
        @media (max-width: 600px) {
          .home-main { padding: 24px 16px !important; }
          .home-buttons { flex-wrap: wrap; justify-content: center; }
          .home-buttons a { flex: 1 1 140px; text-align: center; }
        }
      `}</style>
      <img src="/mathemagic-logo-bg.webp" alt="Mathemagic" style={{ width: '100%', maxWidth: 560, borderRadius: 16 }} />
      ...
      <div className="home-buttons" style={{ display: 'flex', gap: 16, marginTop: 8 }}>
